...
public class App 
{
	...
	{	Scanner sc=new Scanner(System.in);
	   ...
	   if(q1<n)
		...
		List<Sweets> giftbox1 = new ArrayList<>();
		giftbox1.add(jamun);
		giftbox1.add(rasgulla);
		giftbox1.add(kajukatli);
		Comparator<Sweets> titleComparator1 = (c1, c2) -> c1.candiName().compareTo(c2.candiName());
		giftbox1.sort(titleComparator1);
		System.out.println("sorted list in ascending order of candie: " + giftbox1);
		
		giftbox.sort(Collections.reverseOrder(titleComparator1));
		...
		System.out.println(giftbox.contains(silk)); // to check the candie
		System.out.print("Total weight of chocolates in the giftbox : ");
